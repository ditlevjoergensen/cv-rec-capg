...
<h3 align="center">project_title</h3>
  ...
  <p align="center">
    ...
    <br />
    <br />
    <a href="https://github.com/ditlevjoergensen/cv-rec-capg">View Demo</a>
    ·
...
2. Clone the repo
   ```sh
   git clone https://github.com/ditlevjoergensen/cv-rec-capg.git
   ```
...
See the [open issues](https://github.com/ditlevjoergensen/cv-rec-capg/issues) for a full list of proposed features (and known issues).
